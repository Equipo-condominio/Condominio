...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2023 a las 03:16:53
...
CREATE TABLE `public_apartamento` (
  `id_public_apartamento` int(10) UNSIGNED NOT NULL,
  `numero` int(11) DEFAULT NULL,
  `piso` int(11) DEFAULT NULL,
  `valor` int(11) DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') DEFAULT 'Existente',
  `creador` int(10) DEFAULT NULL,
  `id_public_habitante` int(10) UNSIGNED DEFAULT NULL,
  `id_public_condominio` int(10) UNSIGNED DEFAULT NULL
...
INSERT INTO `public_apartamento` (`id_public_apartamento`, `numero`, `piso`, `valor`, `status_eliminado`, `creador`, `id_public_habitante`, `id_public_condominio`) VALUES
(1, 1, 1, NULL, 'Eliminado', NULL, 1, 1),
(2, 2, 1, NULL, 'Existente', NULL, 2, 1),
(3, 3, 2, NULL, 'Existente', NULL, 3, 1),
(4, 4, 3, NULL, 'Existente', NULL, 5, 1),
(5, 1, 1, 10, 'Existente', NULL, 1, 2),
(6, 1, 1, 3, 'Eliminado', 2, 13, 4),
(7, 2, 2, 25, 'Eliminado', 2, 13, 4),
(8, 1, 1, 1, '', 2, 15, 10),
(9, 2, 2, 2, '', 2, 16, 10),
(10, 3, 3, 3, '', 2, 17, 10);
...
CREATE TABLE `public_condominio` (
  `id_public_condominio` int(10) UNSIGNED NOT NULL,
  `rif` int(11) DEFAULT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `cantidad_apartamento` int(11) DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') DEFAULT 'Existente',
  `numero_pisos` int(11) DEFAULT NULL,
  `valor` int(11) DEFAULT NULL,
  `creador` int(10) DEFAULT NULL,
  `public_estado_id` int(11) NOT NULL,
  `public_ciudad_id` int(11) NOT NULL,
  `public_municipio_id` int(11) NOT NULL,
  `public_parroquia_id` int(11) NOT NULL,
  `descripcion` varchar(100) NOT NULL,
  `id_public_fondo_reserva` int(10) UNSIGNED DEFAULT NULL,
  `id_public_users` int(10) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `public_condominio` (`id_public_condominio`, `rif`, `nombre`, `cantidad_apartamento`, `status_eliminado`, `numero_pisos`, `valor`, `creador`, `public_estado_id`, `public_ciudad_id`, `public_municipio_id`, `public_parroquia_id`, `descripcion`, `id_public_fondo_reserva`, `id_public_users`) VALUES
(1, 12484186, 'Condominios El Prexel', 10, 'Existente', 5, 25000, NULL, 12, 212, 146, 464, 'pp', 4, 1),
(2, 3434343, 'Condominios \"Cancerbero\"', 4343, 'Eliminado', 4343, NULL, NULL, 3, 3, 3, 2, '', 2, 2),
(3, 1234579865, 'Condominios \"Inserte Nombre\"', 10, 'Eliminado', 5, 100, NULL, 1, 1, 2, 3, '', 3, 1),
(4, 2, 'Condominios \"Pruebas\"', 20, 'Eliminado', 10, 20000, 2, 1, 2, 5, 2, '', 7, 2),
(9, 3, '3', 3, 'Eliminado', 3, 3, 2, 3, 2, 5, 3, '', 8, 2),
(10, 123456, 'Condominios \"Prueba\"', 5, '', 5, 100000, 2, 6, 88, 68, 226, '', 9, 2);
...
CREATE TABLE `public_factura` (
  `id_public_factura` int(10) UNSIGNED NOT NULL,
  `id_public_condominio` int(10) UNSIGNED DEFAULT NULL,
  `id_public_servicios` int(10) UNSIGNED DEFAULT NULL,
  `id_public_gastos` int(10) UNSIGNED DEFAULT NULL,
  `total` double DEFAULT NULL,
  `iva` double DEFAULT NULL,
  `descuento` double DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') NOT NULL DEFAULT 'Existente',
  `creador` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `public_fondo_reserva` (
  `id_public_fondo_reserva` int(10) UNSIGNED NOT NULL,
  `monto_bs` double DEFAULT NULL,
  `ingreso_bs` double DEFAULT NULL,
  `egreso_bs` double DEFAULT NULL,
  `monto_dollar` double DEFAULT NULL,
  `ingreso_dollar` double DEFAULT NULL,
  `egreso_dollar` double DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') NOT NULL DEFAULT 'Existente',
  `creador` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `public_fondo_reserva` (`id_public_fondo_reserva`, `monto_bs`, `ingreso_bs`, `egreso_bs`, `monto_dollar`, `ingreso_dollar`, `egreso_dollar`, `status_eliminado`, `creador`) VALUES
(1, 433, -14, -303, 100000005263, -99999999992, -5055, 'Existente', NULL),
(2, -1.0000000000000058e18, 0, 1.000000000000006e18, -1.0000000000000002e19, 0, 1.0000000000000002e19, 'Eliminado', NULL),
(3, 20000, 0, 0, 50, 0, 0, 'Eliminado', NULL),
(4, 9999999999999, NULL, NULL, 99999999999999, NULL, NULL, '', NULL),
(5, 8888888888, 0, 0, 888888888888, 0, 0, 'Eliminado', NULL),
(6, 1, 0, 0, 1, 0, 0, 'Eliminado', NULL),
(7, 1146, 1161, 25, 163, 175, 22, 'Eliminado', 2),
(8, 333333, 0, 0, 255555, 0, 0, 'Eliminado', 2),
(9, 13, 10012, 10000, -89989, 100210, 190200, '', 2);
...
CREATE TABLE `public_gastos` (
  `id_public_gastos` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') NOT NULL,
  `creador` int(10) NOT NULL,
  `id_public_condominio` int(10) UNSIGNED NOT NULL,
  `id_public_registro_gastos` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `public_gastos` (`id_public_gastos`, `nombre`, `monto`, `fecha`, `status_eliminado`, `creador`, `id_public_condominio`, `id_public_registro_gastos`) VALUES
(4, 'Bolsas de basura', 100, '2023-05-24', 'Eliminado', 0, 1, 3);
...
CREATE TABLE `public_habitante` (
  `id_public_habitante` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `apellido` varchar(100) DEFAULT NULL,
  `tipo_cedula` enum('V','E','J') DEFAULT NULL,
  `cedula` int(11) DEFAULT NULL,
  `correo` varchar(100) DEFAULT NULL,
  `linea_telefono` enum('0424','0412','0251','0416','0426','0414') DEFAULT NULL,
  `telefono` int(11) DEFAULT NULL,
  `status` enum('Propietario','Inquilino') DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') NOT NULL DEFAULT 'Existente',
...
INSERT INTO `public_habitante` (`id_public_habitante`, `nombre`, `apellido`, `tipo_cedula`, `cedula`, `correo`, `linea_telefono`, `telefono`, `status`, `status_eliminado`, `username`, `password`, `creador`, `ultimo_pago`) VALUES
(1, 'Drexel', 'Colmenarez', 'V', NULL, 'Colmenarez.drexel@gmail.com', '0424', 5344033, 'Propietario', 'Existente', 'username', 'null', 0, NULL),
(2, 'Josue', 'Ramirez', 'V', NULL, 'Correodejosue@gmail.com', '0416', 2548656, 'Propietario', 'Existente', NULL, NULL, 0, NULL),
(3, 'Henry', 'Romero', 'V', 2222, 'HolaSoyHenry@gmail.com', '0424', 2548656, 'Inquilino', 'Existente', '222', '222', 0, NULL),
(4, 'x', 'x', 'V', NULL, 'asdasdasd', '0424', 2547875, 'Propietario', 'Eliminado', 'X', 'null', 0, NULL),
(5, 'sdadssa', 'dfsertfsdf', 'V', NULL, 'dfsdfsd@gmail.com', '', 2589854, 'Propietario', 'Eliminado', NULL, NULL, 0, NULL),
(7, 'drexel', 'apellido1', '', NULL, '', '', NULL, 'Propietario', 'Eliminado', 'null', 'null', 0, NULL),
(8, 'pruebaasd', 'puebaasds', 'V', NULL, 'sadasd@gmail.com', NULL, 5807009, 'Inquilino', 'Eliminado', 'null', 'null', 0, NULL),
(9, 'qwasasasas', 'asdsadasdasd', 'V', NULL, 'sadasdasd', '', 456456, 'Inquilino', 'Eliminado', 'null', 'null', 0, NULL),
(10, 'q', 'q', 'V', NULL, 'a', '0424', 123, 'Propietario', 'Eliminado', 'asdasdasdaaw', 'null', 0, NULL),
(11, 'asd', 'dasd', 'V', NULL, 'asdax', '0424', 4564564, 'Inquilino', 'Eliminado', 'asdawdsd', 'null', 0, NULL),
(12, 'Alex', 'Romero', 'V', NULL, 'AlexRomero@gmail.com', '0424', 254895, 'Propietario', '', 'AlexRomero', '123456', 0, NULL),
(13, 'dre', 'dre', 'V', NULL, 'asdasd', '0424', 4564, 'Propietario', 'Eliminado', 'aeddsa', 'saer', 2, '2023-06-08'),
(15, '1', '1', 'V', 1, '1', '0424', 1, 'Propietario', '', '1', 'eealSvIv2L', 2, '2023-06-09'),
(16, '2', '2', 'V', 2, '2', '0424', 2, 'Propietario', '', '2', 'u9weDfMzYe', 2, '2023-06-16'),
(17, '3', '3', 'V', 3, '3', '0424', 3, 'Propietario', '', '3', 'TLueVySFzw', 2, '2023-05-12');
...
CREATE TABLE `public_registro_de_fondo` (
  `id` int(10) UNSIGNED NOT NULL,
  `monto_bs` double DEFAULT NULL,
  `monto_dollar` double NOT NULL,
  `fondo_reserva_id` int(10) UNSIGNED DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `public_registro_de_pagos` (
  `id_public_registro_de_pagos` int(10) UNSIGNED NOT NULL,
  ...
  `status_eliminado` enum('Existente','Eliminado') DEFAULT NULL,
  `creador` int(10) DEFAULT NULL,
  `id_public_apartamento` int(10) UNSIGNED DEFAULT NULL,
  `id_public_tasa_dia` int(10) UNSIGNED DEFAULT NULL,
  `id_public_factura` int(10) UNSIGNED DEFAULT NULL,
  `id_public_habitante` int(10) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `public_registro_de_pagos`
--

INSERT INTO `public_registro_de_pagos` (`id_public_registro_de_pagos`, `tipo`, `monto_bs`, `monto_dollar`, `fecha`, `concepto`, `banco`, `status_eliminado`, `creador`, `id_public_apartamento`, `id_public_tasa_dia`, `id_public_factura`, `id_public_habitante`) VALUES
(3, 'Transferencia', 123, 123, '2023-06-14', 'asdas', 'asdsa', 'Existente', NULL, 3, 1, NULL, 1),
(4, 'Efectivo', 2, 2, NULL, '232', 'undefined', '', NULL, 2, NULL, NULL, 2),
(5, 'Transferencia', 5, 2, '2023-06-09', '0', 'undefined', '', NULL, 1, NULL, NULL, 1),
(6, 'Efectivo', 2, 2, NULL, '4343', 'undefined', '', NULL, 2, NULL, NULL, 1),
(7, 'Efectivo', 2, 2, NULL, '22', 'undefined', '', NULL, 1, NULL, NULL, 1),
(8, 'Efectivo', 43, 43, NULL, '2', 'undefined', '', NULL, 1, NULL, NULL, 1),
(9, 'Transferencia', 5555, 333, NULL, '343', 'undefined', '', NULL, 1, NULL, NULL, 1),
(10, 'Transferencia', 1e19, 22, '2023-06-09', '2', 'undefined', '', NULL, 1, NULL, NULL, 2),
(11, 'Transferencia', 1, 1, NULL, '2', 'undefined', '', NULL, 1, NULL, NULL, 1),
(12, 'Efectivo', 2, 2, '2023-06-24', '2', 'undefined', '', NULL, 3, NULL, NULL, 2),
(13, 'Efectivo', 4, 4, '2023-06-25', '2', 'undefined', '', NULL, 1, NULL, NULL, 1),
(14, 'Efectivo', 1, 1, '2023-06-16', 'nose', 'undefined', '', 2, 6, NULL, NULL, 13),
(15, 'Efectivo', 100, 100, '2023-06-17', 'pago', 'undefined', '', 2, 6, NULL, NULL, 13),
(16, 'Efectivo', 25, 25, '2023-06-03', '25', 'undefined', '', 2, 6, NULL, NULL, 13),
(17, 'Efectivo', 0, 25, '2023-06-11', '25', 'undefined', '', 2, 6, NULL, NULL, 13),
(18, 'Efectivo', 0, 1000, '2023-06-14', 'x', 'undefined', '', 2, 6, NULL, NULL, 13),
(19, 'Efectivo', 0, 1, '2023-06-10', 'dsf', 'undefined', '', 2, 7, NULL, NULL, 13),
(20, 'Efectivo', 50, 10, '2023-06-08', 'sadad', 'undefined', '', 2, 6, NULL, NULL, 13),
(21, 'Efectivo', 100, 1, '2023-06-08', 'Pago mes 06', 'undefined', '', 2, 8, NULL, NULL, 15),
(22, 'Efectivo', 100, 1, '2023-06-09', 'fds', 'undefined', '', 2, 8, NULL, NULL, 15),
(23, 'Transferencia', 100000, 10000, '2023-06-16', 'pago xyz', 'undefined', '', 2, 9, NULL, NULL, 16),
(24, 'Transferencia', 10, 10, '2023-05-12', 'k', 'undefined', '', 2, 10, NULL, NULL, 17);
...
CREATE TABLE `public_registro_gastos` (
  `id_public_registro_gastos` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` timestamp NULL DEFAULT NULL,
  `status` enum('Pagado','Pendiente') DEFAULT NULL,
  `cancelado_bs` double DEFAULT NULL,
  `cancelado_dollar` double DEFAULT NULL,
  `id_tasa_dia` int(10) UNSIGNED DEFAULT NULL,
  `id_public_condominio` int(11) UNSIGNED DEFAULT NULL,
  `status_eliminado` enum('Existente','Eliminado') NOT NULL,
...
INSERT INTO `public_registro_gastos` (`id_public_registro_gastos`, `nombre`, `monto`, `fecha`, `status`, `cancelado_bs`, `cancelado_dollar`, `id_tasa_dia`, `id_public_condominio`, `status_eliminado`, `creador`) VALUES
(3, 'Bolsas de basura', 5, '2023-07-01 04:00:00', 'Pendiente', 0, 0, 1, 1, 'Eliminado', NULL),
(7, 'asda', 10, '2023-06-03 04:00:00', 'Pendiente', 10, 500, NULL, 1, '', NULL),
(8, 'qewweq', 43, '2023-06-15 04:00:00', 'Pendiente', 4343, 34, NULL, 2, '', NULL),
(9, '2', 2, '2023-06-03 04:00:00', 'Pendiente', 2, 2, NULL, 1, '', NULL),
(10, 'asd', 1000, '2023-06-16 04:00:00', 'Pendiente', NULL, NULL, NULL, 4, '', 2),
(11, 'Tuberia', 22, '2023-06-18 04:00:00', 'Pendiente', 25, NULL, NULL, 4, '', 2),
(12, '25', 25, '2023-06-01 04:00:00', 'Pendiente', 25, 22, NULL, 4, '', 2),
(13, '22', 22, '2023-06-17 04:00:00', 'Pendiente', 25, 25, NULL, 4, '', 2),
(14, 'Luz', 100, '2023-06-22 04:00:00', 'Pagado', NULL, 10000, NULL, 10, '', 2),
(15, 'Agua', 100, '2023-06-23 04:00:00', 'Pagado', NULL, 100, NULL, 10, '', 2),
(16, 'Gas', 100, '2023-06-16 04:00:00', 'Pagado', 10000, 90000, NULL, 10, '', 2);
...
CREATE TABLE `public_registro_servicio` (
  `id_public_registro_servicio` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
...
INSERT INTO `public_registro_servicio` (`id_public_registro_servicio`, `nombre`, `monto`, `fecha`, `status`, `status_eliminado`, `cancelado_bs`, `cancelado_dollar`, `creador`, `id_tasa_dia`, `id_public_condominio`) VALUES
(1, 'Luz', 1000, '2023-05-16', 'Pagado', 'Eliminado', 1000, 500, NULL, 1, 2),
(2, 'Agua', 50, '2023-05-17', 'Pendiente', 'Eliminado', 0, 0, NULL, 1, 0),
(3, 'luz', 100, '0000-00-00', 'Pagado', 'Eliminado', 1e18, 1e19, NULL, 1, 1),
(4, 'asd', 123, '2023-06-17', 'Pagado', '', 123, NULL, NULL, NULL, 1),
(5, '3', 3, '2023-06-10', 'Pagado', '', 3, 3, NULL, NULL, 1),
(6, '2', 2, '2023-06-02', 'Pagado', '', 1e19, 10000000000, NULL, NULL, NULL),
(7, 'asd2', 100, '2023-06-16', 'Pagado', '', NULL, NULL, 2, NULL, 4);
...
CREATE TABLE `public_servicios` (
  `id_public_servicios` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `id_public_condominio` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `public_tasa_dia` (
  `id_public_tasa_dia` int(10) UNSIGNED NOT NULL,
...
(4, 27.021, 1, '2023-06-11', 'Existente'),
(5, 27.021, 1, '2023-06-11', 'Existente'),
(6, 27.021, 1, '2023-06-11', 'Existente'),
(7, 27.021, 1, '2023-06-12', 'Existente'),
(8, 27.021, 1, '2023-06-12', 'Existente'),
(9, 27.021, 1, '2023-06-12', 'Existente'),
(10, 27.021, 1, '2023-06-12', 'Existente'),
(11, 27.278, 1, '2023-06-17', 'Existente'),
(12, 27.278, 1, '2023-06-18', 'Existente'),
(13, 27.278, 1, '2023-06-18', 'Existente'),
(14, 27.278, 1, '2023-06-18', 'Existente'),
(15, 27.278, 1, '2023-06-18', 'Existente'),
(16, 27.278, 1, '2023-06-18', 'Existente'),
(17, 27.278, 1, '2023-06-18', 'Existente'),
(18, 27.278, 1, '2023-06-19', 'Existente'),
(19, 27.278, 1, '2023-06-19', 'Existente'),
(20, 27.278, 1, '2023-06-19', 'Existente');
...
CREATE TABLE `public_users` (
  `id_public_users` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `apellido` varchar(100) DEFAULT NULL,
  `username` varchar(100) DEFAULT NULL,
  `password` varchar(100) DEFAULT NULL,
...
INSERT INTO `public_users` (`id_public_users`, `nombre`, `apellido`, `username`, `password`, `status_eliminado`) VALUES
(1, 'Drexel', 'Colmenarez', 'DrexelColmenarez', '123456', 'Existente'),
(2, 'usuario1', 'apellido1', 'test', '123465', 'Existente'),
(3, 'usuario2', 'apellido2', 'test2', '123465', 'Eliminado'),
(4, 'asd', 'asd', 'asd', 'asdw', 'Eliminado'),
(5, 'system', 'system', 'system', 'secret', 'Existente');
...
--
-- Indices de la tabla `public_apartamento`
--
ALTER TABLE `public_apartamento`
  ADD PRIMARY KEY (`id_public_apartamento`),
  ADD KEY `fk_public_apartamento_public_habitante` (`id_public_habitante`),
  ADD KEY `fk_public_apartamento_public_condominio` (`id_public_condominio`) USING BTREE;

--
-- Indices de la tabla `public_condominio`
--
ALTER TABLE `public_condominio`
  ADD PRIMARY KEY (`id_public_condominio`),
  ADD UNIQUE KEY `rif` (`rif`),
  ADD KEY `fk_public_condominio_public_fondo_reserva` (`id_public_fondo_reserva`),
  ADD KEY `fk_public_condominio_public_users` (`id_public_users`),
  ADD KEY `fk_public_condominio_public_ciudades` (`public_ciudad_id`),
  ADD KEY `fk_public_condominio_public_municipio` (`public_municipio_id`),
  ADD KEY `fk_public_condominio_public_parroquias` (`public_parroquia_id`),
  ADD KEY `fk_public_condominio_public_estados` (`public_estado_id`);

--
-- Indices de la tabla `public_factura`
--
ALTER TABLE `public_factura`
  ADD PRIMARY KEY (`id_public_factura`),
  ADD KEY `fk_public_factura_public_condominio` (`id_public_condominio`),
  ADD KEY `fk_public_factura_public_servicios` (`id_public_servicios`),
  ADD KEY `fk_public_factura_public_gastos` (`id_public_gastos`);

--
-- Indices de la tabla `public_fondo_reserva`
--
ALTER TABLE `public_fondo_reserva`
  ADD PRIMARY KEY (`id_public_fondo_reserva`);

--
-- Indices de la tabla `public_gastos`
--
ALTER TABLE `public_gastos`
  ADD PRIMARY KEY (`id_public_gastos`),
  ADD KEY `id_public_condominio` (`id_public_condominio`),
  ADD KEY `fk_public_gastos_public_registro_gastos` (`id_public_registro_gastos`);

--
-- Indices de la tabla `public_habitante`
--
ALTER TABLE `public_habitante`
  ADD PRIMARY KEY (`id_public_habitante`);

--
-- Indices de la tabla `public_registro_de_fondo`
--
ALTER TABLE `public_registro_de_fondo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_public_registro_de_fondo_public_fondo_reserva` (`fondo_reserva_id`);

--
-- Indices de la tabla `public_registro_de_pagos`
--
ALTER TABLE `public_registro_de_pagos`
  ADD PRIMARY KEY (`id_public_registro_de_pagos`),
  ADD KEY `fk_public_registro_de_pagos_public_apartamento` (`id_public_apartamento`),
  ADD KEY `fk_public_registro_de_pagos_public_tasa_dia` (`id_public_tasa_dia`),
  ADD KEY `fk_public_registro_de_pagos_public_factura` (`id_public_factura`),
  ADD KEY `fk_public_registro_de_pagos_public_habitante` (`id_public_habitante`);

--
-- Indices de la tabla `public_registro_gastos`
--
ALTER TABLE `public_registro_gastos`
  ADD PRIMARY KEY (`id_public_registro_gastos`),
  ADD KEY `id_tasa_dia` (`id_tasa_dia`);

--
-- Indices de la tabla `public_registro_servicio`
--
ALTER TABLE `public_registro_servicio`
  ADD PRIMARY KEY (`id_public_registro_servicio`),
  ADD KEY `fk_public_registro_servicio_public_tasa_dia` (`id_tasa_dia`);

--
-- Indices de la tabla `public_servicios`
--
ALTER TABLE `public_servicios`
  ADD PRIMARY KEY (`id_public_servicios`),
  ADD KEY `fk_public_servicios_public_registro_servicios` (`id_public_registro_servicio`),
  ADD KEY `fk_public_servicios_public_condominio` (`id_public_condominio`);

--
-- Indices de la tabla `public_tasa_dia`
--
ALTER TABLE `public_tasa_dia`
  ADD PRIMARY KEY (`id_public_tasa_dia`);

--
-- Indices de la tabla `public_users`
--
ALTER TABLE `public_users`
  ADD PRIMARY KEY (`id_public_users`);
...
--
-- AUTO_INCREMENT de la tabla `public_apartamento`
--
ALTER TABLE `public_apartamento`
  MODIFY `id_public_apartamento` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `public_condominio`
--
ALTER TABLE `public_condominio`
  MODIFY `id_public_condominio` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `public_factura`
--
ALTER TABLE `public_factura`
  MODIFY `id_public_factura` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `public_fondo_reserva`
--
ALTER TABLE `public_fondo_reserva`
  MODIFY `id_public_fondo_reserva` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `public_gastos`
--
ALTER TABLE `public_gastos`
  MODIFY `id_public_gastos` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `public_habitante`
--
ALTER TABLE `public_habitante`
  MODIFY `id_public_habitante` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `public_registro_de_fondo`
--
ALTER TABLE `public_registro_de_fondo`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `public_registro_de_pagos`
--
ALTER TABLE `public_registro_de_pagos`
  MODIFY `id_public_registro_de_pagos` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `public_registro_gastos`
--
ALTER TABLE `public_registro_gastos`
  MODIFY `id_public_registro_gastos` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `public_registro_servicio`
--
ALTER TABLE `public_registro_servicio`
  MODIFY `id_public_registro_servicio` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `public_servicios`
--
ALTER TABLE `public_servicios`
  MODIFY `id_public_servicios` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `public_tasa_dia`
--
ALTER TABLE `public_tasa_dia`
  MODIFY `id_public_tasa_dia` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `public_users`
--
ALTER TABLE `public_users`
  MODIFY `id_public_users` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
